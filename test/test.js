...
// Flags: --expose-internals --require internal/test/binding
'use strict';
const common = require('./common/index.js');
common.allowGlobals(primordials, internalBinding);

const assert = require('assert');
const { MIMEType, MIMEParams } = require('../lib/mime.js');
...
test(require('./fixtures/mime-whatwg.js'));
test(require('./fixtures/mime-whatwg-generated.js'));
